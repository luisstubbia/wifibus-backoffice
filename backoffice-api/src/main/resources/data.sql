...
INSERT INTO service_terms (lock_version,created_by,created_date,enabled,description,name,TEXT) VALUES (
	...
	now(),
	TRUE,
	'Terms y Condiciones de Córdoba',
	'Municipalidad de Córdoba',
...
INSERT INTO hotspots (lock_version,created_by,created_date,enabled,name,description,router_id) VALUES (
	0,
	'admin',
	now(),
	TRUE,
	'municipalidad-de-cordoba',
	'Hotspot de la Municipalidad de Córdoba',
	(SELECT id FROM routers WHERE name = 'il-gatto-1')
);

INSERT INTO hotspots (lock_version,created_by,created_date,enabled,name,router_id) VALUES (
	0,
	'admin',
	now(),
	TRUE,
	'hotspot2',
	(SELECT id FROM routers WHERE name = 'mac-donalds-3')
);
